...
public class PostRecipeController {
    ...
    public ResponseEntity<Message> postRecipe(@RequestBody PostRecipe.Request request) {
        ...
        PostRecipe.ResponseDetail response = postRecipeService.postRecipe(member, request);
    ...
    public ResponseEntity<Message> getPostRecipe() {
        List<PostRecipe.Response> responseList = postRecipeService.getPostRecipe();
    ...
    public ResponseEntity<Message> getRecipeDetail(@PathVariable Long id) {
        PostRecipe.ResponseDetail response = postRecipeService.getRecipeDetail(id);
